...
var global = __webpack_require__(0);
var createNonEnumerableProperty = __webpack_require__(2);
...
var IS_PURE = __webpack_require__(10);
...
var anObject = __webpack_require__(8);
var defineProperties = __webpack_require__(46);
...
/* harmony import */ var core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(38);
/* harmony import */ var core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var inputmask__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(36);
/* harmony import */ var inputmask__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(inputmask__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _styles_main_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(68);
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let im = new inputmask__WEBPACK_IMPORTED_MODULE_1___default.a("+7(999)999-99-99", {
    showMaskOnHover: false,
    showMaskOnFocus: true
  });
  im.mask(telInput); // AOS.init();

  const findPos = function findPos(obj) {
    let curtop = 0;
  ...
  cosmonaut1.style.left = titlePageBox.right - 350 + "px";
  window.addEventListener("resize", () => {
    titlePageBox = titlePage.getBoundingClientRect();
    console.log(titlePageBox.right);
    cosmonaut1.style.left = titlePageBox.right - 150 + "px";
  });

  const getTabActionServices = function getTabActionServices(container) {
  ...
  const getTabActionAdvantages = function getTabActionAdvantages(container) {
  ...
  const getScaleImg = function getScaleImg() {
    ...
    function createObserver() {
      ...
      const buildThresholdList = function buildThresholdList() {
        let thresholds = [];
        let numSteps = 20;
      ...
      const handleIntersect = function handleIntersect(entries, observer) {
  ...
  getScaleImg(); // const galleryItems = document.querySelectorAll('.item-gallary')
  //
  ...
  const getSubmitForm = function getSubmitForm(form) {
    form.addEventListener('submit', function (evt) {
      ...
      for (const input of inputs) {
        if (!input.value) {
          input.parentNode.classList.add('input-wrapper--error');
          return false;
        } else {
          input.parentNode.classList.remove('input-wrapper--error');
        }
      }
    });
  };

  const consultform = document.querySelector('.consult-block__form'); // getSubmitForm(consultform);

  document.querySelector('.up-to-form').addEventListener('click', function () {
    document.querySelector('.consult-block__form').scrollIntoView({
      block: "center",
      behavior: "smooth"
    });
  });
  const btns = document.querySelectorAll('.modal-btn');
  const formRequest = document.querySelector('#request-modal form');

  for (const btn of btns) {
    btn.addEventListener('click', function () {
      console.log(this.dataset);
      formRequest.querySelector('.hidden-input').value = this.dataset.typeEmail;
      $.fancybox.open({
        src: '#request-modal',
        type: 'inline'
      });
...
var global = __webpack_require__(0);
var DOMIterables = __webpack_require__(40);
...
var internalObjectKeys = __webpack_require__(26);
var enumBugKeys = __webpack_require__(14);
...
var IS_PURE = __webpack_require__(10);
var Iterators = __webpack_require__(16);
var IteratorsCore = __webpack_require__(33);
...
var IteratorPrototype = __webpack_require__(33).IteratorPrototype;
var create = __webpack_require__(25);
var createPropertyDescriptor = __webpack_require__(12);
var setToStringTag = __webpack_require__(35);
var Iterators = __webpack_require__(16);
